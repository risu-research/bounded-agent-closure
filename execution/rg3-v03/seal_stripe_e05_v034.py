...
EXPECTED_EXECUTOR_SHA256='0be42e97bb8a0e9ef966cadadfea2211f2443fac4bceff9bebea21a56be41603'
...
def main()->int:
    ...
    if att.get('phase')!='LIVE_E0_V0_3_4_COMPLETE': raise SystemExit('E0.5 refused: wrong live attestation phase')
    ...
    lock={
      ...
      'execution_compatibility_version':'0.3.4','executor_sha256':EXPECTED_EXECUTOR_SHA256,
